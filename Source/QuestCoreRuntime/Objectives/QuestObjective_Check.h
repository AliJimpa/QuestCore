...
#include "QuestObjective_Check.generated.h"
 ...
 */
UCLASS(meta = (DisplayName = "Check"))
class QUESTCORERUNTIME_API UQuestObjective_Check : public UQuestObjective
{
    GENERATED_BODY()
...
protected:
    virtual void Construction(UQuestComponent *Quest) override
    {
        ...
        if (TargetObjective)
        {
            TargetObjective->Construction(Quest);
        }
    }
...
public:
    ...
    virtual FString GetObjectiveDescription_Implementation() const override { return TargetObjective->GetObjectiveDescription(); }
};