...
#include "AssetDefinition_QuestObjective.generated.h"

#define LOCTEXT_NAMESPACE "AssetDefinition_QuestObjective"

UCLASS()
class QUESTCOREEDITOR_API UAssetDefinition_QuestObjective : public UAssetDefinitionDefault
{
    GENERATED_BODY()
...
public:
    ...
    {
        return LOCTEXT("QuestObjective", "Definition");
    }
